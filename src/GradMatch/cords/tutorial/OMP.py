...
config = f'{expr_name}_pretrained-{args.pretrained}_frozen-{args.frozen}_model-{args.arch}_numclasses-{args.numclasses}_select-subset-every-{args.select_subset_every}_budget-{args.data_budget}_batchsize-{args.trn_batch_size}_model-train-batchsize-{args.model_train_batch_size}_start-{args.start}_end-{args.end}_jump_ckpts-{args.jump_ckpts}_perclass-{args.per_class}_joint_optimization-{args.joint_optim}'
