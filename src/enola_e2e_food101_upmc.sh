...
home_dir=/u/npatil/Cleanup/Mycroft-Data-Sharing/src
...
# MT Root parameters
enola_base_dir='//work/hdd/bdgs/npatil/test/Final'
#enola_base_dir='/work/hdd/bdgs/npatil/test/optim'
mt_dataset="food101"
mt_config="full"
mt_classes=101

MT_dataset_dir='/projects/bdgs/zsarwar/data/food-101/DF'
do_dataset="upmcfood101"
do_config="full"
DO_dataset_dir='/projects/bdgs/zsarwar/data/UPMC-food-101/DF'
# root_config --> subset
# Hash configs
