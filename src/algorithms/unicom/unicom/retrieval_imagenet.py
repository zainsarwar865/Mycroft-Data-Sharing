...
parser.add_argument("--df_retrieve_path_val", type=str, default="", required=True)
...
def get_metric(
    ...
    if gallery is None:
        ...
        torch.save(query_label, retrieval_save_filename + "_query_label.t")
        torch.save(pred_index, retrieval_save_filename + "_pred_index.t")
        torch.save( pred_label, retrieval_save_filename + "_pred_label.t")
        return rank_1 * 100
    else:
        query = query.cuda()
        query_label = query_label
